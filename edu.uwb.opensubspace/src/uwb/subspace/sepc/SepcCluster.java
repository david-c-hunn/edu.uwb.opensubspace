...
public class SepcCluster extends Cluster {
    ...
    public void setWidth(double width) { this.m_width = width; }

    public double getBeta() { return m_beta; }
    public void setBeta(double beta) { this.m_beta = beta; }
     ...
     *            (2) Otherwise overlap is the number of instances in the
     * calling
     *                Cluster that occur in the other Cluster divided by the
     * total
